...
public class RustGenerator extends DefaultCodegenConfig {
    ...
    protected String packageAuthors = "Unnamed Author <unnamed@example.com>";
     ...
     */
        ...
        cliOptions.add(new CliOption(CodegenConstants.PACKAGE_AUTHORS, "Authors of this module.")
                .defaultValue(packageName));
    ...
    public void processOpts() {
        ...
        if (additionalProperties.containsKey(CodegenConstants.PACKAGE_AUTHORS)) {
            this.setPackageAuthors((String) additionalProperties.get(CodegenConstants.PACKAGE_AUTHORS));
        } else {
    ...
    public Map<String, Object> postProcessOperations(Map<String, Object> objs) {
        ...
        for (CodegenOperation operation : operations) {
            ...
            System.out.println(operation.operationId+operation.getIsString());
        }
    ...
    public void setPackageAuthors(String packageName) {
